                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6 col-12">
                                            ...
                                            <option value="{{ $value->id }}"
                                                {{ old('subject', isset($college_course->id) ? $college_course->id : '') == $value->id ? 'selected' : '' }}>
                                                {{ $value->name }}</option>
                                        @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" id="seat_no" class="form-control"
                                                    data-validation-required-message="This First Name field is required"
                                                    name="seat_no" value="{{$college_course->seat_no}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                ...
                                                <input type="text" id="merit_seat" class="form-control" value="{{$college_course->merit_seat}}" name="merit_seat">
                                            </div>
                                        </div>
                                    </div>
