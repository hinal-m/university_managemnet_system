                ...
                <div class="col-6">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form id="submit_form" action="{{ route('college.merit.update',$college_course->id) }}" method="post"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <select id="course_id" name="course_id" class="form-control course">
                                            ...
                                            @foreach ($college_merit['college_course'] as $value)
                                                <option value="{{$value->id==$college_course->course_id ?'selected' :''}}">{{ $value->Course->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group mb-2 " >
                                        <label for="reserved_seat">Select Round</label>
                                                  <select name="round_no" id="" class="form-control round">
