<div class="app-sidebar menu-fixed" data-background-color="man-of-steel" data-image="{{ asset('saller-assets/app-assets/img/sidebar-bg/01.jpg') }}" data-scroll-to-active="true">
   <div class="sidebar-header">
      <div class="logo clearfix"><a class="logo-text float-left" href="{{route('college.dashboard')}}">
            <div class="logo-img">Student</div>
   ...
   <div class="sidebar-content main-menu-content">
      <div class="nav-container">
         <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <!-- Dashboard -->
            <li class=" nav-item"><a href="{{ route('user.dashboard') }}" class="text-decoration-none"><i class="ft-home"></i><span class="menu-title" data-i18n="Chat">Dashboard</span></a>
            ...
            <li class="">
               <a href="{{route('user.addmission.create')}}" class="text-decoration-none">
                  <i class="fa fa-shopping-basket"></i>
                  <span class="menu-title" data-i18n="Email">Adminssion</span>
               </a>
            </li>
            <li class="">
               <a href="{{route('user.marks.create')}}" class="text-decoration-none">
                  <i class="fa fa-shopping-basket"></i>
