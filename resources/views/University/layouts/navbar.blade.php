            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                    ...
                    <a class="dropdown-item preview-item">
                        ...
                        <div class="preview-item-content">
                            <p class="preview-subject mb-1" href="{{ route('university.university.logout') }}"
                                    onclick="event.preventDefault();document.getElementById('logout-form').submit();">Log out</p>
                                    <form action="{{ route('university.university.logout') }}" method="post" class="d-none" id="logout-form">
                                        @csrf</form>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
